let game = (function () {
    ...
    let board = {
        ...
        moveOnce: function (incomeArr) {
            ...
            //let liveNeighboursInner;

            // let ttt = next.map((item,index,arr)=> item.map((itemInner,indexInner,arrInner)=> {
            //      liveNeighboursInner = this.checkForNeighbours(index, indexInner);
            //
            //     return itemInner === 0 ? liveNeighboursInner === 3 ? 1 : 0 : liveNeighboursInner < 2 || liveNeighboursInner > 3 ? 0 : 1
            //
            //     }));
            //console.log(ttt);
        ...
        moveRepeatedly: function (chosenAction) {
             intervalHolder = setInterval(this.moveOnce.bind(this), 120);
